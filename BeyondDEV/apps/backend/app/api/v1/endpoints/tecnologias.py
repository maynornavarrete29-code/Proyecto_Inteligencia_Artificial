...
def get_tecnologia_repo(db = Depends(get_db)):
...
@router.post("")
async def create_tecnologias(tecnologia: TecnologiaSchema, repo: TecnologiaRepository = Depends(get_tecnologia_repo)):
